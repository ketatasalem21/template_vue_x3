<template>
  <div v-if="isOpen" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-6xl max-h-[90vh] m-4 overflow-hidden">
      <!-- Header -->
      <div class="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-sage-blue-700 to-blue-600">
      ...
      <div class="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
        <div class="flex items-center space-x-4">
          ...
          <!-- Sélecteur de vue -->
          <div class="flex bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600">
            <button
              v-for="view in views"
              :key="view.id"
        ...
        <div class="flex items-center space-x-3">
          <div class="relative">
            ...
            <input
              ...
              class="pl-10 pr-4 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-sage-blue-500"
            />
          </div>
          
          <select
            v-model="selectedCategory"
            class="px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-sage-blue-500"
          >
      ...
      <div class="flex h-[calc(90vh-160px)]">
        ...
        <div class="flex-1 overflow-hidden">
          <!-- Vue Mois -->
          <div v-if="currentView === 'month'" class="h-full p-4">
            <CalendarMonthView
          ...
          <!-- Vue Semaine -->
          <div v-else-if="currentView === 'week'" class="h-full p-4">
            <CalendarWeekView
              :current-date="currentDate"
              :events="filteredEvents"
              :selected-date="selectedDate"
          ...
          <!-- Vue Jour -->
          <div v-else-if="currentView === 'day'" class="h-full p-4">
            <CalendarDayView
          ...
          <!-- Vue Agenda -->
          <div v-else-if="currentView === 'agenda'" class="h-full p-4">
            <CalendarAgendaView
              :events="filteredEvents"
        ...
        <!-- Sidebar droite -->
        <div class="w-80 border-l border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700 overflow-y-auto">
