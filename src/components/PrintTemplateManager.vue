            ...
            <div class="space-y-2">
              ...
              >
                <div class="flex items-center space-x-3">
                  <component :is="docType.icon" class="w-5 h-5 text-sage-blue-700 dark:text-sage-blue-400" />
                  <div class="flex-1">
        ...
        <div class="flex-1 flex flex-col sm:flex-row">
          ...
          <div class="w-full sm:w-80 bg-white dark:bg-gray-800 border-b sm:border-b-0 sm:border-r border-gray-200 dark:border-gray-700 overflow-y-auto">
            <div v-if="selectedDocumentType" class="p-3 sm:p-4">
              ...
              <div class="space-y-2">
                ...
                <div v-if="filteredTemplates.length === 0" class="text-center py-8 text-gray-500 dark:text-gray-400">
                  ...
                  <button
                    @click="createNewTemplate"
                    class="mt-2 px-3 py-1 text-white rounded text-sm hover:opacity-80 transition-colors"
                    style="background-color: rgb(7, 58, 111);"
                  >
            ...
            <div v-else class="p-8 text-center text-gray-500 dark:text-gray-400">
              <Receipt class="w-12 h-12 mx-auto mb-4 text-gray-300 dark:text-gray-600" />
          ...
          <div class="flex-1 flex flex-col">
            <!-- Configuration -->
            <div v-if="selectedTemplate" class="w-full bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 overflow-y-auto max-h-96">
            ...
            <div class="flex-1 bg-gray-50 dark:bg-gray-900 p-3 sm:p-4 overflow-y-auto">
              ...
              <div v-if="selectedTemplate && selectedDocumentType" class="bg-white rounded-lg shadow-lg p-8 max-w-2xl mx-auto">
...
const getTemplateCount = (documentTypeId) => {
  return allTemplates.value.filter(template => template.documentType === documentTypeId).length
}
...
const createNewTemplate = () => {
  ...
  const newTemplate = {
    ...
    description: `Description du nouveau modèle ${selectedDocumentType.value.name}`,
    isDefault: false,
    sections: {
      header: {
        showLogo: true,
...
const saveTemplate = () => {
  if (selectedTemplate.value) {
    ...
    if (index > -1) {
      ...
      allTemplates.value.push({ ...selectedTemplate.value })
    }
...
const getSampleData = (documentTypeId) => {
  const sampleData = {
    ...
    order: {
      ...
      total: 3000.00,
      items: [
        { description: 'Matière première A', quantity: 50, unitPrice: 25.00, total: 1250.00 },
        { description: 'Matière première B', quantity: 25, unitPrice: 50.00, total: 1250.00 }
      ]
    },
    technical_sheet: {
      number: 'FT-2024-001',
      ...
      date: '2024-01-15',
      specifications: 'Spécifications techniques détaillées du produit...',
      materials: 'Acier inoxydable 316L',
      instructions: 'Instructions d\'utilisation et de maintenance...'
    }
  }
