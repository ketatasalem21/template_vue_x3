<template>
  <div v-if="isOpen" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-6xl max-h-[90vh] m-4 overflow-hidden">
      <!-- Header -->
      <div class="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 bg-sage-blue-700">
        <div class="flex items-center space-x-4">
          ...
          <div class="relative">
            ...
            <input
              ...
              class="bg-white/10 text-white placeholder-gray-300 border border-white/20 pl-10 pr-4 py-2 rounded text-sm focus:outline-none focus:ring-2 focus:ring-white/30 w-96"
            />
            <button
              v-if="searchTerm"
              @click="searchTerm = ''"
      ...
      <div class="flex h-[calc(90vh-80px)]">
        <!-- Left Sidebar -->
        <div class="w-48 bg-gray-50 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 overflow-y-auto">
